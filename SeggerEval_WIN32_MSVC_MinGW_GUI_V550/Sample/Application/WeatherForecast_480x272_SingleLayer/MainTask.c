...
void MainTask(void) {
  ...
  // Create text window
  //
  pData->hText = WM_CreateWindowAsChild(XPOS_TEXT, 0, XSIZE_TEXT, YSIZE_TEXT, pData->hWin, WM_CF_SHOW | WM_CF_HASTRANS, _cbText, sizeof(WINDOW_DATA *));
  //
  // Create forecast window
  //
  pData->hBar = WM_CreateWindowAsChild(0, YPOS_FORECAST, 480, YSIZE_FORECAST, pData->hWin, WM_CF_SHOW | WM_CF_HASTRANS, _cbBar, sizeof(WINDOW_DATA *));
  //
