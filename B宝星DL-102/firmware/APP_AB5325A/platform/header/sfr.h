...
#define PIANOCON        SFR_RW (SFR9_BASE + 0x30*4)
#define PIANOBUF        SFR_WO (SFR9_BASE + 0x31*4)
#define TONEDLY         SFR_RW (SFR9_BASE + 0x32*4)
#define TONEDLY1        SFR_RW (SFR9_BASE + 0x33*4)
#endif
