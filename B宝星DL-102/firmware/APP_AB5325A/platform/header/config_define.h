...
#define CH_AUXL_VCMBUF      0x04    //VCMBUF     -> left aux
#define CH_AUXL_MIC_PF2     0x05    //MIC(PF2)   -> left aux
#define CH_AUXL_MIC_PF5     0x06    //MIC(PF5)   -> left aux
#define CH_AUXL_VOUTRP      0x07    //VOUTRP     -> left aux
#define CH_MIC_PF2          0x0c    //MIC(PF2)   -> left mic
#define CH_MIC_PF5          0x0d    //MIC(PF5)   -> left mic
...
#define CH_AUXR_VCMBUF      0x40    //VCMBUF     -> right aux
#define CH_AUXR_MIC_PF2     0x50    //MIC(PF2)   -> right aux
#define CH_AUXR_MIC_PF5     0x60    //MIC(PF5)   -> right aux
/*****************************************************************************
